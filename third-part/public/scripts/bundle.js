...
document.addEventListener('DOMContentLoaded', function () {
    var i = new Date();
    var globalDate = new Date(i.getFullYear(), i.getMonth(), i.getDate(), 3, 0, 0);
    ...
    var getAll = async function getAll() {
        ...
        await setInterval(async function () {
            if ((0, _jquery2.default)('.update_event_wrapper').is(':hidden')) {
                await getEventsFromDB(globalDate);
                await updateRoomsList(rooms);
                await updateTimesOfEvents(events2, rooms);
                await update_time_now(globalDate);
    ...
    (0, _jquery2.default)('#rooms').niceScroll({
        autohidemode: true,
    ...
    document.querySelector('.arr_container:first-of-type').addEventListener('click', function () {
        var cells = document.querySelectorAll('td');
        for (var _i = 0; _i < cells.length; _i++) {
            cells[_i].style.backgroundColor = '#F6F7F9';
            if (!cells[_i].classList.contains('day')) {
                cells[_i].innerHTML = '';
            }
        }
        var year = document.querySelector('.calendar_container>article:nth-of-type(2)').dataset.year;
        var month = document.querySelector('.calendar_container>article:nth-of-type(2)').dataset.month - 1;
        var setDate = new Date(year, month, 1);
        setCalendar(setDate);
    });

    document.querySelector('.arr_container:last-of-type').addEventListener('click', function () {
        var cells = document.querySelectorAll('td');
        for (var _i2 = 0; _i2 < cells.length; _i2++) {
            if (!cells[_i2].classList.contains('day')) {
                cells[_i2].innerHTML = '';
                cells[_i2].style.backgroundColor = '#F6F7F9';
            }
        }
        var year = document.querySelector('.calendar_container>article:nth-of-type(2)').dataset.year;
        var month = +document.querySelector('.calendar_container>article:nth-of-type(2)').dataset.month + 1;
    ...
    document.querySelectorAll('.arr')[0].addEventListener('click', function () {
        var i = new Date(globalDate);
        var day = 86400000;
    ...
    document.querySelectorAll('.arr')[1].addEventListener('click', function () {
        var i = new Date(globalDate);
    ...
    (0, _jquery2.default)(document).click(async function (e) {
        var func1 = function func1(e) {
            if (check[0]) {

                var div2 = (0, _jquery2.default)(".update_block");
                var div3 = (0, _jquery2.default)(".update_blank");
                var div4 = (0, _jquery2.default)(".update_button");

                if (e.target === check[1] || e.target.classList[0] === div2[0].classList[0] || e.target.classList[0] === div3[0].classList[0] || e.target.classList[0] === div4[0].classList[0]) {} else {
                    check[1].style.backgroundColor = "";
                    (0, _jquery2.default)(".update_block").css("display", "none").animate({ opacity: 1 }, 200);
                }
            }
        };

        var func2 = function func2(e) {
            var target = e.target;
            if (target.classList.contains('close_time')) {
                if (target.dataset.finished == '1') {
                    (0, _jquery2.default)('.update_button').css('display', 'none');
                } else {
                    (0, _jquery2.default)('.update_button').css('display', 'block');
                }
                check[0] = true;
                check[1] = e.target;
                ...
                var pad = document.querySelector("#global_wrapper").getBoundingClientRect().left;
                var left2 = left + width / 2 - 169 - pad;
                if (left2 < 245) {
                    left2 = 245;
                }
                if (left2 > 940) {
                ...
                var top = target.getBoundingClientRect().bottom;
                (0, _jquery2.default)(".update_block").css("display", "block").animate({ opacity: 1 }, 200);
                (0, _jquery2.default)('.update_block').css('left', left2);
                (0, _jquery2.default)('.update_block').css('top', top - 7);
                var up = (0, _jquery2.default)(".update_block")[0].getBoundingClientRect().left - pad;
                var event_width = target.offsetWidth;
                (0, _jquery2.default)('.before').css('left', left - pad - up + event_width / 2 - 6);
            }
        };

        var func3 = function func3(e) {
            var target = e.target;
            if (target.classList.contains('empty_time')) {
                ...
                var day = (0, _jquery2.default)('#date').val().split(" ")[0];
                var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
                for (var _i3 = 0; _i3 < mounths.length; _i3++) {
                    if (mounth == mounths[_i3]) {
                        mounth = +_i3;
                    }
                }
                var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
                var eventStartHours = +(0, _jquery2.default)('#start').val().split(":")[0];
                var eventStartMinutes = +(0, _jquery2.default)('#start').val().split(":")[1];
                var start = new Date(year, mounth, day, eventStartHours, eventStartMinutes, 0);
                var now = new Date();
                if (Date.parse(start) < Date.parse(now) - 60000) {
                    (0, _jquery2.default)('#start').css('backgroundColor', '#fadfe4');
                } else {

                    var eventEndHours = +(0, _jquery2.default)('#end').val().split(":")[0];
                    var eventEndMinutes = +(0, _jquery2.default)('#end').val().split(":")[1];
                    var end = new Date(year, mounth, day, eventEndHours, eventEndMinutes, 0);
                    if (Date.parse(end) <= Date.parse(start)) {
                        (0, _jquery2.default)('#end').css('backgroundColor', '#fadfe4');
                    } else {
                        var dateForRecomend = {
                            start: start,
                            end: end
                ...
                (0, _jquery2.default)('#rooms').css('display', 'none');
                (0, _jquery2.default)('label[for="rooms"]').css('display', 'none');
                (0, _jquery2.default)('#room').css('display', 'block');
                (0, _jquery2.default)('label[for="room"]').css('display', 'block');
                (0, _jquery2.default)('#start').css('borderColor', '#E9ECEF');
                (0, _jquery2.default)('#end').css('borderColor', '#E9ECEF');
                (0, _jquery2.default)('#start').css('backgroundColor', 'white');
                (0, _jquery2.default)('#end').css('backgroundColor', 'white');
                (0, _jquery2.default)('#users').css('borderColor', '#E9ECEF');
                (0, _jquery2.default)('#date').css('borderColor', '#E9ECEF');
                (0, _jquery2.default)('#name').css('borderColor', '#E9ECEF');
                (0, _jquery2.default)('#rooms').css('borderColor', '');
                (0, _jquery2.default)('.scrollable_section').css('display', "none");
                (0, _jquery2.default)('.update_event_wrapper').css('display', 'block');
                (0, _jquery2.default)('.create_event').css('display', 'none');
                (0, _jquery2.default)('.date_now').css('display', 'none');
                (0, _jquery2.default)(".update_block").css("display", "none").animate({ opacity: 1 }, 200);
            }
        };

        var func4 = function func4(e) {
            if (e.target.classList.contains('roomInRooms')) {
                (0, _jquery2.default)('#rooms').css('borderColor', '');
                var roomBlock = document.querySelector('#room');
                var selectedRoom = e.target;
                var start = selectedRoom.firstElementChild.innerHTML.split('—')[0];
                var end = selectedRoom.firstElementChild.innerHTML.split('—')[1];
        ...
        var func5 = function func5(e) {
            if (e.target.classList.contains('after')) {
                var _rooms = document.querySelectorAll('.roomInRooms>article:first-of-type');

                for (var _i4 = 0; _i4 < _rooms.length; _i4++) {
                    _rooms[_i4].innerHTML = document.querySelector('#room>article:first-of-type').innerHTML;
                }
        ...
        var func6 = function func6(e) {
            if (e.target.tagName == "TD" && !e.target.classList.contains('day') && e.target.dataset.disable != '1') {
                var year = e.target.dataset.date.split(',')[0];
                var month = e.target.dataset.date.split(',')[1];
                var day = e.target.dataset.date.split(',')[2];
        ...
        var func9 = async function func9(e) {
            if (e.target.classList.contains('forSending')) {
                ...
                var day = (0, _jquery2.default)('#date').val().split(" ")[0];
                var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
                for (var _i6 = 0; _i6 < mounths.length; _i6++) {
                    if (mounth == mounths[_i6]) {
                        mounth = +_i6;
                    }
                }
                var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
    ...
    var setInfoForEmpty = function setInfoForEmpty(e) {
        var start = '';
        var end = '';
        var roomId = '';
        var day = '';
        ...
        var right = e.target.offsetWidth + left;
        var time_left = document.querySelector('.absolutely').offsetLeft;
        var hours = void 0;
        var minutes = void 0;
        var mobile = document.querySelector('#global_wrapper').classList.contains('mobile');
        var padding = 31;
        if (mobile) {
            padding = 53;
        }
        ...
        var idNow = 0;
        for (var _i7 = 0; _i7 < events2.length; _i7++) {
            idNow = idNow + +events2[_i7].id;
        }
        ...
        var timeStart = globalDate.toISOString();
        var date = new Date();
        ...
        var roomTitle = rooms[roomId - 1].title;
        var roomFloor = rooms[roomId - 1].floor;
        document.querySelector('#name').value = '';
        (0, _jquery2.default)('#start').val(start);
        (0, _jquery2.default)('#end').val(end);
        (0, _jquery2.default)('#date').val(day + ' ' + mounth + ', ' + year);
        document.querySelector('#room').dataset.roomId = roomId;
        document.querySelector('#room').innerHTML = '\n            <div class="after"></div>\n            <article>' + start + '\u2014' + end + '</article>\n            <article>' + roomTitle + ' \xB7 ' + roomFloor + ' \u044D\u0442\u0430\u0436</article>\n            ';
    ...
    var setInfo = function setInfo(target, rooms, users) {
        var mounths = ['января', 'февраля', 'марта', 'апреля', 'мая', 'июня', 'июля', 'августа', 'сентября', 'октября', 'ноября', 'декабря'];
        var title = target.dataset.eventTitle;
        var day = target.dataset.day;
        var mounth = mounths[target.dataset.mounth];
        var start = target.dataset.start;
        var end = target.dataset.end;
        var eventId = target.dataset.id;
        var roomTitle = rooms[target.dataset.roomId - 1].title;
        var usersId = target.dataset.usersId.split(',');
        var firstUser = users[usersId[1] - 1].login;
        var img_user = users[usersId[1] - 1].avatarUrl;
        var userLenght = usersId.length - 1;
        ...
        if (userLenght.lastIndexOf(I) == 0 && (userLenght < 10 || userLenght > 20)) {
            scream = 'участник';
        } else if ((userLenght.lastIndexOf(want[0]) == 0 || userLenght.lastIndexOf(want[1]) == 0 || userLenght.lastIndexOf(want[2]) == 0) && (lastNumbers < 5 || lastNumbers > 20)) {
            scream = "участника";
        } else {
            scream = "участников";
        }
        ...
        document.querySelector('.update_blank .time_updt').innerHTML = '\n               ' + day + ' ' + mounth + ', ' + start + '\u2014' + end + ' <span class="updt" style=\'padding-right:5px;\'></span>\xB7<span class="updt" style=\'padding-left:5px;\'></span> ' + roomTitle + '\n            ';
    ...
    (0, _jquery2.default)('.update_button').click(function () {
        createRooms();
        setInfoForUpdate();
        (0, _jquery2.default)('#rooms').css('display', 'none');
        (0, _jquery2.default)('label[for="rooms"]').css('display', 'none');
    ...
    var setInfoForUpdate = function setInfoForUpdate() {
        if (document.querySelector('.update_event').classList.contains('create_new_event')) {
        ...
        var id = document.querySelector('.update_blank').dataset.eventId;
        var event = '';
        for (var _i8 = 0; _i8 < events2.length; _i8++) {
            if (events2[_i8].id == id) {
                event = events2[_i8];
            }
        }
        removeUsers();
        ...
        var roomTitle = rooms[event.room.id - 1].title;
        var roomFloor = rooms[event.room.id - 1].floor;
        var start = event.dateStart;
        var timeStart = Date.parse(start);
        var date = new Date();
        date.setTime(timeStart);
        var hours = date.getHours();
        var day = date.getDate();
        var mounths = ['января', 'февраля', 'марта', 'апреля', 'мая', 'июня', 'июля', 'августа', 'сентября', 'октября', 'ноября', 'декабря'];
        var mounth = mounths[date.getMonth()];
        ...
        (0, _jquery2.default)('#name').val(title);
        (0, _jquery2.default)('#start').val(start);
        (0, _jquery2.default)('#end').val(end);
        (0, _jquery2.default)('#date').val(day + ' ' + mounth + ', ' + year);
    ...
    (0, _jquery2.default)('footer>div:first-of-type, .close_round').click(function () {
        (0, _jquery2.default)('#rooms').css('display', 'none');
        (0, _jquery2.default)('.create_event').css('display', 'block');
        (0, _jquery2.default)('.scrollable_section').css('display', "block");
        (0, _jquery2.default)('.update_event_wrapper').css('display', 'none');
        (0, _jquery2.default)('.date_now').css('display', 'block');
        if (document.querySelector('#global_wrapper').offsetWidth > 660) {
            (0, _jquery2.default)('.scrollable_section').scrollLeft(0);
            update_time_now(globalDate);
            var arr_floor = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
            var arr_name = document.querySelectorAll('.room_name');
            for (var _i9 = 0; _i9 < arr_floor.length; _i9++) {
                arr_floor[_i9].style.left = 0;
            }
            for (var _i10 = 0; _i10 < arr_name.length; _i10++) {
                arr_name[_i10].style.left = 0;
            }
        } else {
            (0, _jquery2.default)('.scrollable_section').scrollLeft(0);
            update_time_now(globalDate);
            var _arr_floor = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
            var _arr_name = document.querySelectorAll('.room_name');
            for (var _i11 = 0; _i11 < _arr_floor.length; _i11++) {
                _arr_floor[_i11].style.left = "16px";
            }
            for (var _i12 = 0; _i12 < _arr_name.length; _i12++) {
                _arr_name[_i12].style.left = "16px";
            }
        }
    });

    (0, _jquery2.default)('footer>div:nth-of-type(2)').click(function () {
        (0, _jquery2.default)('.background_modal').css('display', 'block');
        (0, _jquery2.default)('.ask_delete').css('display', 'block');
    });

    (0, _jquery2.default)('.ask_close').click(function () {
        (0, _jquery2.default)('.background_modal').css('display', 'none');
        (0, _jquery2.default)('.ask_delete').css('display', 'none');
    });

    (0, _jquery2.default)('.delete_button').click(function () {
        (0, _jquery2.default)('.background_modal').css('display', 'none');
        (0, _jquery2.default)('.ask_delete').css('display', 'none');
        var id = document.querySelector('.update_blank').dataset.eventId;
        var sendData = {
    ...
    (0, _jquery2.default)('footer>div:last-of-type, footer>div:nth-of-type(3)').click(function () {
        (0, _jquery2.default)('#start').css('borderColor', '#E9ECEF');
        (0, _jquery2.default)('#end').css('borderColor', '#E9ECEF');
        (0, _jquery2.default)('#users').css('borderColor', '#E9ECEF');
        (0, _jquery2.default)('#date').css('borderColor', '#E9ECEF');
        ...
        var succesStart = '';
        var succesEnd = '';
        var succesTitle = (0, _jquery2.default)('#name').val();
        var succesUsers = [];
        var succesRoom = void 0;
        /*----------------------------------------*/
        var selectedUsers = document.querySelectorAll('.selected_users article');
        for (var _i13 = 0; _i13 < selectedUsers.length; _i13++) {
            succesUsers.push(+selectedUsers[_i13].dataset.userId);
        }
        if (succesUsers.length < 2) {
            (0, _jquery2.default)('#users').css('borderColor', 'red');
        } else {
            var askEmptyTime = true;
            var roomId = document.querySelector('#room').dataset.roomId;
            succesRoom = +roomId;
            var id = document.querySelector('.update_blank').dataset.eventId;
            succesId = id;
            var mounths = ['января', 'февраля', 'марта', 'апреля', 'мая', 'июня', 'июля', 'августа', 'сентября', 'октября', 'ноября', 'декабря'];
            var day = (0, _jquery2.default)('#date').val().split(" ")[0];
            var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
            for (var _i14 = 0; _i14 < mounths.length; _i14++) {
                if (mounth == mounths[_i14]) {
                    mounth = +_i14;
                }
            }
            var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
            ...
            var eventStartMinutes = +(0, _jquery2.default)('#start').val().split(":")[1];
            var start = new Date(year, mounth, day, eventStartHours, eventStartMinutes, 0);
            var sendingDate = new Date(start.getFullYear(), start.getMonth(), start.getDate(), 3, 0, 0);
            var getEventsForDate = async function getEventsForDate(date) {
                date = date.toISOString();
                return await _jquery2.default.ajax({
                    type: 'GET',
                    ...
                    success: function success(data) {
                        ...
                        var itemEvents = [];
                        var sortDataStart = void 0;
                        var sortDataEnd = void 0;
                        var day = date.getDate();
                        var month = date.getMonth();
                        var year = date.getFullYear();
                        sortDataStart = new Date(year, month, day, 8, 0, 0);
                        sortDataEnd = new Date(year, month, day, 23, 0, 0);
                        for (var _i15 = 0; _i15 < events.length; _i15++) {
                            var itemDateStart = Date.parse(events[_i15].dateStart);
                            var itemDateEnd = Date.parse(events[_i15].dateEnd);
                            if (itemDateStart >= sortDataStart && itemDateStart <= sortDataEnd && itemDateEnd >= sortDataStart && itemDateEnd <= sortDataEnd) {
                                itemEvents.push(events[_i15]);
                            }
                        }
                        return itemEvents;
                    }
            ...
            var itemEvents = getEventsForDate(sendingDate);
            ...
            succesEnd = end;
            var startMinutes = eventStartHours * 60 + eventStartMinutes;
            var endMinutes = eventEndHours * 60 + eventEndMinutes;
            var time_now = new Date();
            if ((0, _jquery2.default)('#room').is(':hidden')) {
                (0, _jquery2.default)('#rooms').css('borderColor', 'red');
            } else if ((0, _jquery2.default)('#name').val().length < 1) {

                (0, _jquery2.default)('#name').css('borderColor', 'red');
            } else if ((0, _jquery2.default)('#date').val().length < 1) {
                (0, _jquery2.default)('#date').css('borderColor', 'red');
            } else if ((0, _jquery2.default)('#start').val().length < 1) {
                (0, _jquery2.default)('#start').css('borderColor', 'red');
            } else if ((0, _jquery2.default)('#end').val().length < 1) {
                (0, _jquery2.default)('#end').css('borderColor', 'red');
                ...
                for (var _i16 = 0; _i16 < room_events.length; _i16++) {
                    if (room_events[_i16].id !== id) {
                        var startOfEvent = Date.parse(start);
                        var endOfEvent = Date.parse(end);
                        var startOfItem = Date.parse(room_events[_i16].start);
                        var endOfItem = Date.parse(room_events[_i16].end);
                        var _date = new Date();
                        _date.setTime(startOfEvent);
                        console.log(_date.getHours() + ":" + _date.getMinutes());
                        _date = new Date();
                        _date.setTime(endOfEvent);
                        console.log(_date.getHours() + ":" + _date.getMinutes());
                        _date = new Date();
                        _date.setTime(startOfItem);
                        console.log(_date.getHours() + ":" + _date.getMinutes());
                        _date = new Date();
                        _date.setTime(endOfItem);
                        console.log(_date.getHours() + ":" + _date.getMinutes());
                        var start1 = startOfEvent;
                        var end1 = endOfEvent - 60000;
                        var start2 = startOfItem;
                        var end2 = endOfItem;
                        if ((start1 < start2 || start1 > end2 - 60000) && (end1 < start2 || end1 > end2) && (start2 < start1 || start2 > end1)) {} else {
                            askEmptyTime = false;
                        }
                    }
                }
                ...
                var ask = document.querySelector('.update_event').classList.contains('create_new_event');

                /*-----------------------*/

                if (askEmptyTime) {
                    document.querySelectorAll('.succes_date')[1].innerHTML = day + ' ' + mounths[mounth] + ', ' + (0, _jquery2.default)('#start').val() + ' \u2014 ' + (0, _jquery2.default)('#end').val();
                    document.querySelectorAll('.succes_room')[1].innerHTML = '' + document.querySelectorAll('#room article')[1].textContent;
                    document.querySelectorAll('.succes_date')[0].innerHTML = day + ' ' + mounths[mounth] + ', ' + (0, _jquery2.default)('#start').val() + ' \u2014 ' + (0, _jquery2.default)('#end').val();
                    document.querySelectorAll('.succes_room')[0].innerHTML = '' + document.querySelectorAll('#room article')[1].textContent;
    ...
    (0, _jquery2.default)('.succes_button').click(function () {
        (0, _jquery2.default)('.background_modal').css('display', 'none');
        (0, _jquery2.default)('.succes_updating').css('display', 'none');
        (0, _jquery2.default)('.succes_creating').css('display', 'none');
    });

    (0, _jquery2.default)('#start').on('input', function () {
        var timeReg = /^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/;
        if (timeReg.test((0, _jquery2.default)('#start').val())) {
            (0, _jquery2.default)('#start').css('backgroundColor', 'white');
            if (!timeReg.test((0, _jquery2.default)('#end').val())) {
                (0, _jquery2.default)('#end').css('backgroundColor', '#fadfe4');
            } else {
                ...
                var day = (0, _jquery2.default)('#date').val().split(" ")[0];
                var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
                for (var _i17 = 0; _i17 < mounths.length; _i17++) {
                    if (mounth == mounths[_i17]) {
                        mounth = +_i17;
                    }
                }
                var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
                ...
                if (Date.parse(start) < Date.parse(now) - 60000) {
                    ...
                    if (Date.parse(end) <= Date.parse(start)) {
                        ...
                        (0, _jquery2.default)('#start').css('borderColor', '#E9ECEF');
                        document.querySelector('#room>article:first-of-type').innerHTML = '\n            ' + (0, _jquery2.default)('#start').val() + '\u2014' + (0, _jquery2.default)('#end').val() + '\n            ';
                        var roomsInRooms = document.querySelectorAll('.roomInRooms');
                        for (var _i18 = 0; _i18 < roomsInRooms.length; _i18++) {
                            roomsInRooms[_i18].firstElementChild.innerHTML = '\n            ' + (0, _jquery2.default)('#start').val() + '\u2014' + (0, _jquery2.default)('#end').val() + '\n            ';
                        }
                    }
                }
            }
    ...
    (0, _jquery2.default)('#end').on('input', function () {
        ...
        if (timeReg.test((0, _jquery2.default)('#end').val())) {
            ...
            if (!timeReg.test((0, _jquery2.default)('#start').val())) {
                ...
                var day = (0, _jquery2.default)('#date').val().split(" ")[0];
                var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
                for (var _i19 = 0; _i19 < mounths.length; _i19++) {
                    if (mounth == mounths[_i19]) {
                        mounth = +_i19;
                    }
                }
                var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
                ...
                if (Date.parse(start) < Date.parse(now) - 60000) {
                    ...
                    if (Date.parse(end) <= Date.parse(start)) {
                        ...
                        document.querySelector('#room>article:first-of-type').innerHTML = '\n            ' + (0, _jquery2.default)('#start').val() + '\u2014' + (0, _jquery2.default)('#end').val() + '\n            ';
                        var roomsInRooms = document.querySelectorAll('.roomInRooms');
                        for (var _i20 = 0; _i20 < roomsInRooms.length; _i20++) {
                            roomsInRooms[_i20].firstElementChild.innerHTML = '\n            ' + (0, _jquery2.default)('#start').val() + '\u2014' + (0, _jquery2.default)('#end').val() + '\n            ';
                        }
                    }
                }
            }
    ...
    (0, _jquery2.default)('#name').on('input', function () {
        (0, _jquery2.default)('#name').css('borderColor', '#E9ECEF');
    });

    (0, _jquery2.default)('#date').on('input', function () {
        (0, _jquery2.default)('#date').css('borderColor', '#E9ECEF');
    });

    (0, _jquery2.default)('#users').on('input', function () {
        var allUsers = document.querySelectorAll('.addUser article[data-user-id]');
        for (var _i21 = 0; _i21 < allUsers.length; _i21++) {
            allUsers[_i21].style.display = "block";
        }
        var hasUsers = [];
        var notUsers = [];
        for (var _i22 = 0; _i22 < allUsers.length; _i22++) {
            var itemName = allUsers[_i22].lastChild.firstChild;
            itemName = itemName.textContent;
            itemName = itemName.substr(0, itemName.length - 3);
            var search = (0, _jquery2.default)('#users').val().toUpperCase();
            if (itemName.toUpperCase().indexOf(search) + 1) {
                hasUsers.push(allUsers[_i22]);
            } else {
                notUsers.push(allUsers[_i22]);
            }
        }
        for (var j = 0; j < notUsers.length; j++) {
            notUsers[j].style.display = "none";
        }
        for (var _i23 = 0; _i23 < allUsers.length; _i23++) {
            document.querySelector('.addUser').removeChild(allUsers[_i23]);
        }
        var finalUsers = hasUsers.concat(notUsers);
        for (var _i24 = 0; _i24 < finalUsers.length; _i24++) {
            document.querySelector('.addUser').appendChild(finalUsers[_i24]);
        }
    });
    ...
    (0, _jquery2.default)(window).resize(function () {
        ...
        if (document.querySelector('#global_wrapper').offsetWidth > 660) {
            ...
            var arr_floor = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
            var arr_name = document.querySelectorAll('.room_name');
            for (var _i25 = 0; _i25 < arr_floor.length; _i25++) {
                arr_floor[_i25].style.left = 0;
            }
            for (var _i26 = 0; _i26 < arr_name.length; _i26++) {
                arr_name[_i26].style.left = 0;
            }
        } else {
            if (document.querySelector('#global_wrapper').classList.contains('desctop')) {
            ...
            (0, _jquery2.default)('.scrollable_section').scrollLeft(0);
            update_time_now(globalDate);
            var _arr_floor2 = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
            var _arr_name2 = document.querySelectorAll('.room_name');
            for (var _i27 = 0; _i27 < _arr_floor2.length; _i27++) {
                _arr_floor2[_i27].style.left = "16px";
            }
            for (var _i28 = 0; _i28 < _arr_name2.length; _i28++) {
                _arr_name2[_i28].style.left = "16px";
            }
        }
    });

    (0, _jquery2.default)('.scrollable_section_y').scroll(function () {
    ...
    (0, _jquery2.default)('.scrollable_section').scroll(function () {

        if (check[0]) {
            check[1].style.backgroundColor = "";
            (0, _jquery2.default)(".update_block").css("display", "none").animate({ opacity: 1 }, 200);
        }
        var padding = (0, _jquery2.default)('.scrollable_section').scrollLeft();

        var arr_floor = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
        var arr_name = document.querySelectorAll('.room_name');
        for (var _i29 = 0; _i29 < arr_floor.length; _i29++) {
            arr_floor[_i29].style.left = padding + 16 + "px";
        }
        if (padding > 181) {
            for (var _i30 = 0; _i30 < arr_name.length; _i30++) {
                arr_name[_i30].style.left = padding + 16 + "px";
                arr_name[_i30].classList.add('scrolling_room_name');
            }
        } else {
            for (var _i31 = 0; _i31 < arr_name.length; _i31++) {
                arr_name[_i31].style.left = 16 + "px";
                arr_name[_i31].classList.remove('scrolling_room_name');
            }
        }
    });

    (0, _jquery2.default)(".create_event").click(function () {
        (0, _jquery2.default)('#start').css('borderColor', '#E9ECEF');
        (0, _jquery2.default)('#end').css('borderColor', '#E9ECEF');
        (0, _jquery2.default)('#start').css('backgroundColor', 'white');
        (0, _jquery2.default)('#end').css('backgroundColor', 'white');
        ...
        setInfoForCreate();
        var idNow = 0;
        for (var _i32 = 0; _i32 < events2.length; _i32++) {
            idNow = idNow + +events2[_i32].id;
        }
        document.querySelector('.update_blank').dataset.eventId = idNow;
        events2.push({
            id: idNow,
        ...
        (0, _jquery2.default)('#rooms').css('display', 'block');
        (0, _jquery2.default)('label[for="rooms"]').css('display', 'block');
        (0, _jquery2.default)('#room').css('display', 'none');
        (0, _jquery2.default)('label[for="room"]').css('display', 'none');
        (0, _jquery2.default)('.scrollable_section').css('display', "none");
        (0, _jquery2.default)('.update_event_wrapper').css('display', 'block');
        (0, _jquery2.default)('.create_event').css('display', 'none');
        (0, _jquery2.default)('.date_now').css('display', 'none');
    ...
    var createRooms = function createRooms() {
        document.querySelector('#rooms').innerHTML = '';
        for (var _i33 = 0; _i33 < rooms.length; _i33++) {
            var room = document.createElement('section');
            room.classList.add('roomInRooms');
            room.dataset.roomId = rooms[_i33].id;
            room.dataset.roomCapacity = rooms[_i33].capacity;
            room.innerHTML = '\n              <article>12:00\u201413:00</article>\n              <article>' + rooms[_i33].title + ' \xB7 ' + rooms[_i33].floor + ' \u044D\u0442\u0430\u0436</article>\n              ';
            document.querySelector('#rooms').appendChild(room);
        }
    };

    var setInfoForCreate = function setInfoForCreate() {
        document.querySelector('.update_event h1').innerHTML = 'Новая встреча';
        if (!document.querySelector('.update_event').classList.contains('create_new_event')) {
            document.querySelector('.update_event').classList.add('create_new_event');
            document.querySelector('footer').classList.add('create_new_event');
    ...
    document.querySelector('.users_list>section').addEventListener('mousedown', function (e) {
        var event = e.target;
        var getParent = function getParent(event) {
        ...
        var id = document.querySelector('.update_blank').dataset.eventId;
        var event2 = '';
        for (var _i34 = 0; _i34 < events2.length; _i34++) {
            if (events2[_i34].id == id) {
                event2 = events2[_i34];
            }
        }
        ...
        var timeReg = /^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/;
        if (timeReg.test((0, _jquery2.default)('#end').val()) && timeReg.test((0, _jquery2.default)('#start').val())) {
            (0, _jquery2.default)('#end').css('backgroundColor', 'white');
            if (!timeReg.test((0, _jquery2.default)('#start').val())) {
                (0, _jquery2.default)('#start').css('backgroundColor', '#fadfe4');
            } else {
                ...
                var day = (0, _jquery2.default)('#date').val().split(" ")[0];
                var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
                for (var _i35 = 0; _i35 < mounths.length; _i35++) {
                    if (mounth == mounths[_i35]) {
                        mounth = +_i35;
                    }
                }
                var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
    ...
    (0, _jquery2.default)(".selected_users").click(function (e) {
        var event = e.target;
        if (event.classList.contains('delete_user')) {
            var getParent = function getParent(event) {
                return event.parentElement || event.parentNode;
            };
            var article = getParent(event);
            var id = document.querySelector('.update_blank').dataset.eventId;
            var event2 = '';
            for (var _i36 = 0; _i36 < events2.length; _i36++) {
                if (events2[_i36].id == id) {
                    event2 = events2[_i36];
                }
            }
            ...
            if (timeReg.test((0, _jquery2.default)('#end').val()) && timeReg.test((0, _jquery2.default)('#start').val())) {
                ...
                if (!timeReg.test((0, _jquery2.default)('#start').val())) {
                    ...
                    var day = (0, _jquery2.default)('#date').val().split(" ")[0];
                    var mounth = (0, _jquery2.default)('#date').val().split(" ")[1].substr(0, (0, _jquery2.default)('#date').val().split(" ")[1].length - 1);
                    for (var _i37 = 0; _i37 < mounths.length; _i37++) {
                        if (mounth == mounths[_i37]) {
                            mounth = +_i37;
                        }
                    }
                    var year = +(0, _jquery2.default)('#date').val().split(" ")[2];
    ...
    (0, _jquery2.default)('#users').focus(function () {
        (0, _jquery2.default)('.users_list').css("display", "block").animate({ opacity: 1 }, 200);
        (0, _jquery2.default)(".addUser").niceScroll({
            cursorcolor: "#D5DFE9",
            cursorwidth: "8px",
            cursoropacitymin: 1,
            scrollspeed: 60,
    ...
    (0, _jquery2.default)('#users').focusout(function () {
        (0, _jquery2.default)('.users_list').animate({ opacity: 0 }, 0, function () {
            (0, _jquery2.default)('.users_list').css("display", "none");
            (0, _jquery2.default)('#users').val('');
        });
    });
});
/*------------------------------time_now--------------------------------------------------*/
...
var update_time = function update_time() {
    ...
    if (now >= 480 && now <= 1380) {
        ...
        var padding = document.querySelector('.absolutely').offsetLeft;
        var padd = document.querySelector('aside').offsetWidth;
        ...
        document.querySelector('.absolutely').style.display = "block";
        var _padding = document.querySelector('.absolutely').offsetLeft;
        var _padd = document.querySelector('aside').offsetWidth;
        document.querySelector('.absol').style.left = _padding - 24 + +_padd + "px";
        document.querySelector('.absol').style.display = "block";
        ...
        document.querySelector('.absol').innerHTML = _hours + ":" + _minutes;
    } else {
        document.querySelector('.absolutely').style.left = 0 * 1.1 + "px";
        document.querySelector('.absolutely').style.display = "block";
        var _padding2 = document.querySelector('.absolutely').offsetLeft;
        var _padd2 = document.querySelector('aside').offsetWidth;
        document.querySelector('.absol').style.left = _padding2 - 24 + +_padd2 + "px";
        document.querySelector('.absol').style.display = "block";
        var _hours2 = date.getHours();
        var _minutes2 = date.getMinutes();
        if (_minutes2 < 10) {
            _minutes2 = "0" + _minutes2;
        }
        document.querySelector('.absol').innerHTML = _hours2 + ":" + _minutes2;
    }
};

/*---------------------------disable_time-----------------------------------------*/

var update_time_now = function update_time_now(globalDate) {
    var now = new Date();
    var day_now = new Date(now.getFullYear(), now.getMonth(), now.getDate(), 3, 0, 0);

    if (Date.parse(globalDate) == Date.parse(day_now)) {
        globalDate = new Date();
        updateGlobalDate(globalDate);
        if ((0, _jquery2.default)('.update_event_wrapper').is(':hidden')) {
            var times = document.querySelectorAll('.dis_time');
            update_time();
            var abs_padd = document.querySelector('.absolutely').offsetLeft;
            var glob_padd = document.querySelector('#global_wrapper').getBoundingClientRect().left;
            var padd = abs_padd;
            for (var i = 0; i < times.length; i++) {
                times[i].style.width = padd + "px";
            }
            var empty_times = document.querySelectorAll('.empty_time');
            for (var _i38 = 0; _i38 < empty_times.length; _i38++) {
                var left = empty_times[_i38].getBoundingClientRect().left;
                var right = empty_times[_i38].getBoundingClientRect().right;
                var padd2 = document.querySelector('.absolutely').getBoundingClientRect().left;
                var width = right - left;
                if (right - padd2 < 16.5) {
                    empty_times[_i38].style.zIndex = '-1';
                }
                if (empty_times[_i38].offsetLeft < padd) {
                    empty_times[_i38].style.backgroundPosition = width / 2 + (padd2 - left) / 2 - 5 + "px";
                }
            }
            var close_times = document.querySelectorAll('.close_time');
            for (var _i39 = 0; _i39 < close_times.length; _i39++) {
                var _right = close_times[_i39].getBoundingClientRect().right;
                var _padd3 = document.querySelector('.absolutely').getBoundingClientRect().left;
                if (_padd3 - _right >= 0) {
                    close_times[_i39].dataset.finished = '1';
                }
            }
        }
        ...
        document.querySelector('.absolutely').style.display = "block";
        var padding = document.querySelector('.absolutely').offsetLeft;
        var _padd4 = document.querySelector('aside').offsetWidth;
        document.querySelector('.absol').style.left = padding - 24 + +_padd4 + "px";
        document.querySelector('.absol').style.opacity = '0';
        document.querySelector('.absol').style.display = "block";
        var _times = document.querySelectorAll('.dis_time');
        for (var _i40 = 0; _i40 < _times.length; _i40++) {
            _times[_i40].style.width = '100%';
        }
        var _close_times = document.querySelectorAll('.close_time');
        for (var _i41 = 0; _i41 < _close_times.length; _i41++) {
            var _right2 = _close_times[_i41].getBoundingClientRect().right;
            var _padd5 = document.querySelector('.absolutely').getBoundingClientRect().left;
            if (_padd5 - _right2 >= 0) {
                _close_times[_i41].dataset.finished = '1';
            }
        }
    } else {
        document.querySelector('.absolutely').style.left = 0 * 1.1 + "px";
        document.querySelector('.absolutely').style.opacity = '0';
        document.querySelector('.absolutely').style.display = "block";
        var _padding3 = document.querySelector('.absolutely').offsetLeft;
        var _padd6 = document.querySelector('aside').offsetWidth;
        document.querySelector('.absol').style.left = _padding3 - 24 + +_padd6 + "px";
        document.querySelector('.absol').style.opacity = '0';
        document.querySelector('.absol').style.display = "block";
...
var setCalendar = function setCalendar(set_date) {
    var date = new Date(set_date.getFullYear(), set_date.getMonth() - 1, 1);
    ...
    for (var k = 1; k < 4; k++) {
        ...
        for (var i = 2; i < 7; i++) {
            for (var j = 1; j < 8; j++) {
                ...
                var cell = document.querySelector('.calendar_container>article:nth-of-type(' + k + ')>table>tbody>tr:nth-of-type(' + i + ')>td:nth-of-type(' + j + ')');
                if (i == 2 && j < first_day) {
...
var updateTimesOfEvents = function updateTimesOfEvents(events, rooms) {
    var room_events = [];
    for (var i = 0; i < rooms.length; i++) {
        var div_dis = document.createElement('div');
    ...
    for (var o = 0; o < room_events.length; o++) {

        var roomsOfFloor = room_events[o];

        roomsOfFloor.sort(function (a, b) {
            var dateStart_a = Date.parse(a.start);
            var dateStart_b = Date.parse(b.start);
        ...
        var counter = 480;
        for (var _i42 = 0; _i42 < roomsOfFloor.length; _i42++) {
            var start = new Date();
            var end = new Date();
            var dateStart = Date.parse(roomsOfFloor[_i42].start);
            start.setTime(dateStart);
            var day = start.getDate();
            var mounth = start.getMonth();
            var dateEnd = Date.parse(roomsOfFloor[_i42].end);
            end.setTime(dateEnd);
            ...
            if (start >= 480 && start < 1380) {
                ...
                var _users = '';
                for (var k = 0; k < roomsOfFloor[_i42].users.length; k++) {
                    if (k == roomsOfFloor[_i42].users.length - 1) {
                        _users = _users + roomsOfFloor[_i42].users[k].id;
                    } else {
                        _users = _users + roomsOfFloor[_i42].users[k].id + ',';
                    }
                }
                div2.dataset.usersId = _users;
                div2.style.width = width2 + "px";
                document.querySelector('.events_time[data-room-id="' + (o + 1) + '"]').appendChild(div2);
                if (_i42 === roomsOfFloor.length - 1) {
                    var width3 = (1380 - counter) * 1.1;
...
/*-----------------------send_update---------------------------------------------------*/
var sendAndUpdate = async function sendAndUpdate(ask, sendData, sendDataNew, globalDate) {
    if (ask) {
        await _jquery2.default.ajax({
            type: 'POST',
            url: '/graphql',
    ...
    if (document.querySelector('#global_wrapper').offsetWidth > 660) {
        ...
        var arr_floor = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
        var arr_name = document.querySelectorAll('.room_name');
        for (var i = 0; i < arr_floor.length; i++) {
            arr_floor[i].style.left = 0;
        }
        for (var _i43 = 0; _i43 < arr_name.length; _i43++) {
            arr_name[_i43].style.left = 0;
        }
    } else {
        (0, _jquery2.default)('.scrollable_section').scrollLeft(0);
        update_time_now(globalDate);
        var _arr_floor3 = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
        var _arr_name3 = document.querySelectorAll('.room_name');
        for (var _i44 = 0; _i44 < _arr_floor3.length; _i44++) {
            _arr_floor3[_i44].style.left = "16px";
        }
        for (var _i45 = 0; _i45 < _arr_name3.length; _i45++) {
            _arr_name3[_i45].style.left = "16px";
        }
    }
    if (ask) {
        (0, _jquery2.default)('.background_modal').css('display', 'block');
        (0, _jquery2.default)('.succes_creating').css('display', 'block');
    } else {
        (0, _jquery2.default)('.background_modal').css('display', 'block');
        (0, _jquery2.default)('.succes_updating').css('display', 'block');
    }
};

var removeEvent = async function removeEvent(sendData, globalDate) {
    await _jquery2.default.ajax({
        type: 'POST',
        url: '/graphql',
        contentType: "application/json; charset=utf-8",
    ...
    if (document.querySelector('#global_wrapper').offsetWidth > 660) {
        ...
        for (var _i46 = 0; _i46 < arr_name.length; _i46++) {
            arr_name[_i46].style.left = 0;
        }
    } else {
        (0, _jquery2.default)('.scrollable_section').scrollLeft(0);
        update_time_now(globalDate);
        var _arr_floor4 = document.querySelectorAll('aside>ul>li>ul>li:first-of-type');
        var _arr_name4 = document.querySelectorAll('.room_name');
        for (var _i47 = 0; _i47 < _arr_floor4.length; _i47++) {
            _arr_floor4[_i47].style.left = "16px";
        }
        for (var _i48 = 0; _i48 < _arr_name4.length; _i48++) {
            _arr_name4[_i48].style.left = "16px";
        }
    }
};
...
(0, _jquery2.default)('#rooms>p').click(async function (e) {});

/*--------------------------get_recomendation----------------------*/

var getRecomendation = async function getRecomendation(date, members, rooms, users) {
    var dateForSearch = new Date(date.start.getFullYear(), date.start.getMonth(), date.start.getDate(), 3, 0, 0);
    var itemsEvents = [];
    var itemRooms = [];
    for (var i = 0; i < rooms.length; i++) {
    ...
    await _jquery2.default.ajax({
        ...
        dataType: "json",
        success: function success(data) {
            var date = new Date(Date.parse(dateForSearch));
            events = data.data.events;
            var sortDataStart = void 0;
            var sortDataEnd = void 0;
            var day = date.getDate();
            ...
            sortDataStart = new Date(year, month, day, 8, 0, 0);
            sortDataEnd = new Date(year, month, day, 23, 0, 0);
            for (var _i49 = 0; _i49 < events.length; _i49++) {
                var itemDateStart = Date.parse(events[_i49].dateStart);
                var itemDateEnd = Date.parse(events[_i49].dateEnd);
                if (itemDateStart >= sortDataStart && itemDateStart <= sortDataEnd && itemDateEnd >= sortDataStart && itemDateEnd <= sortDataEnd) {
                    itemsEvents.push(events[_i49]);
                }
            }
        }
    });
    for (var k = 0; k < itemRooms.length; k++) {
        var roomId = itemRooms[k].id;
        var room_events = [];
        for (var j = 0; j < itemsEvents.length; j++) {
        ...
        for (var _i50 = 0; _i50 < room_events.length; _i50++) {
            if (room_events[_i50].id !== document.querySelector('.update_blank').dataset.eventId) {
                var startOfEvent = Date.parse(date.start);
                var endOfEvent = Date.parse(date.end);
                var startOfItem = Date.parse(room_events[_i50].start);
                var endOfItem = Date.parse(room_events[_i50].end);
                var start1 = startOfEvent;
                var end1 = endOfEvent - 60000;
                var start2 = startOfItem;
                var end2 = endOfItem;
    ...
    var usersFloors = [];
    for (var _i51 = 0; _i51 < document.querySelector('.selected_users').childNodes.length; _i51++) {
        usersFloors.push(document.querySelector('.selected_users').childNodes[_i51].dataset.userFloor);
    }

    itemRooms.sort(function (a, b) {
        var firstFloor = a.floor;
        var secondFloor = b.floor;
        var sumA = 0;
        var sumB = 0;
        for (var _j = 0; _j < usersFloors.length; _j++) {
            sumA = sumA + Math.abs(firstFloor - usersFloors[_j]);
            sumB = sumB + Math.abs(secondFloor - usersFloors[_j]);
        }
        if (sumA < sumB) {
            return -1;
        }
    ...
    document.querySelector('#rooms').innerHTML = '';
    for (var _i52 = 0; _i52 < itemRooms.length; _i52++) {
        if (itemRooms[_i52]) {
            if (itemRooms[_i52].capacity >= document.querySelector('.selected_users').childNodes.length) {
                var room = document.createElement('section');
                room.classList.add('roomInRooms');
                room.dataset.roomId = rooms[_i52].id;
                room.dataset.roomCapacity = rooms[_i52].capacity;
                room.innerHTML = '\n              <article>' + (0, _jquery2.default)('#start').val() + '\u2014' + (0, _jquery2.default)('#end').val() + '</article>\n              <article>' + itemRooms[_i52].title + ' \xB7 ' + itemRooms[_i52].floor + ' \u044D\u0442\u0430\u0436</article>\n              ';
                document.querySelector('#rooms').appendChild(room);
            }
        }
    }
    if (document.querySelector('#rooms').childNodes.length < 1) {
        ...
        (0, _jquery2.default)('#rooms').css('display', 'block');
        (0, _jquery2.default)('label[for="rooms"]').css('display', 'block');
        var eventsOnInterval = [];
        for (var _i53 = 0; _i53 < itemsEvents.length; _i53++) {
            var start = Date.parse(itemsEvents[_i53].dateStart);
            var end = Date.parse(itemsEvents[_i53].dateEnd);

            if (date.start >= start - 360000 && end >= date.end - 360000) {
                eventsOnInterval.push(itemsEvents[_i53]);
            }
        }

        console.log(eventsOnInterval);

        for (var _k = 0; _k < rooms.length; _k++) {
            var _roomId = rooms[_k].id;
            var _room_events = [];
            for (var _j2 = 0; _j2 < itemsEvents.length; _j2++) {
                if (itemsEvents[_j2].room.id == _roomId) {

                    _room_events.push({
                        id: itemsEvents[_j2].id,
                        users: itemsEvents[_j2].users,
                        title: itemsEvents[_j2].title,
                        start: itemsEvents[_j2].dateStart,
                        end: itemsEvents[_j2].dateEnd
                    });
                }
            }

            for (var l = 0; l < eventsOnInterval.length; l++) {
                var ask = true;
                for (var _i54 = 0; _i54 < _room_events.length; _i54++) {
                    var _startOfEvent = Date.parse(eventsOnInterval[l].dateStart);
                    var _endOfEvent = Date.parse(eventsOnInterval[l].dateEnd);
                    var _startOfItem = Date.parse(_room_events[_i54].start);
                    var _endOfItem = Date.parse(_room_events[_i54].end);
                    var _start = _startOfEvent;
                    var _end = _endOfEvent - 60000;
                    var _start2 = _startOfItem;
                    var _end2 = _endOfItem;
                    if ((_start < _start2 || _start > _end2 - 60000) && (_end < _start2 || _end > _end2) && (_start2 < _start || _start2 > _end)) {} else {
                        ask = false;
                    }
                }
                if (ask) {
                    if (rooms[_k].capacity >= eventsOnInterval[l].users.length) {
                        var _room = void 0;
                        ...
                        if (_room.capacity >= document.querySelector('.selected_users').childNodes.length) {
                            document.querySelector('#rooms').innerHTML = document.querySelector('#rooms').innerHTML + ('<p class="forSending" data-event-id="' + eventsOnInterval[l].id + '" data-room-id="' + rooms[_k].id + '">\u041F\u0435\u0440\u0435\u043D\u0435\u0441\u0442\u0438 \u0432\u0441\u0442\u0440\u0435\u0447\u0443 \xAB' + eventsOnInterval[l].title + '\xBB \u0432 \u043A\u043E\u043C\u043D\u0430\u0442\u0443 \xAB' + rooms[_k].title + '\xBB</p>');
                        }
                    }
                }
            }
    ...
    if (document.querySelector('#rooms').childNodes.length < 1) {
        var eventsInInterval = [];
        for (var _i55 = 0; _i55 < itemsEvents.length; _i55++) {
            var _start3 = Date.parse(itemsEvents[_i55].dateStart);
            var _end3 = Date.parse(itemsEvents[_i55].dateEnd);

            if (_start3 > date.start && _start3 < date.end || _end3 > date.start && _end3 < date.end) {
                eventsInInterval.push(itemsEvents[_i55]);
            }
        }

        console.log(eventsInInterval);

        for (var _k2 = 0; _k2 < rooms.length; _k2++) {
            var _roomId2 = rooms[_k2].id;
            var _room_events2 = [];
            for (var _j3 = 0; _j3 < itemsEvents.length; _j3++) {
                if (itemsEvents[_j3].room.id == _roomId2) {

                    _room_events2.push({
                        id: itemsEvents[_j3].id,
                        users: itemsEvents[_j3].users,
                        title: itemsEvents[_j3].title,
                        start: itemsEvents[_j3].dateStart,
                        end: itemsEvents[_j3].dateEnd
                    });
                }
            }

            for (var _l = 0; _l < eventsInInterval.length; _l++) {
                var _ask = true;
                for (var _i56 = 0; _i56 < _room_events2.length; _i56++) {
                    var _startOfEvent2 = Date.parse(eventsInInterval[_l].dateStart);
                    var _endOfEvent2 = Date.parse(eventsInInterval[_l].dateEnd);
                    var _startOfItem2 = Date.parse(_room_events2[_i56].start);
                    var _endOfItem2 = Date.parse(_room_events2[_i56].end);
                    var _start4 = _startOfEvent2;
                    var _end4 = _endOfEvent2 - 60000;
                    var _start5 = _startOfItem2;
                    var _end5 = _endOfItem2;
                    if ((_start4 < _start5 || _start4 > _end5 - 60000) && (_end4 < _start5 || _end4 > _end5) && (_start5 < _start4 || _start5 > _end4)) {} else {
                        _ask = false;
                    }
                }
                if (_ask) {
                    if (rooms[_k2].capacity >= eventsInInterval[_l].users.length) {
                        var _room2 = void 0;
                        for (var _p = 0; _p < rooms.length; _p++) {
                            if (rooms[_p].id == eventsInInterval[_l].room.id) {
                                _room2 = rooms[_p];
                            }
                        }
                        var eventsOnItemRoom = [];
                        for (var f = 0; f < itemsEvents.length; f++) {
                            if (itemsEvents[f].room.id == _room2.id) {
                        ...
                        for (var _i57 = 0; _i57 < eventsOnItemRoom.length; _i57++) {
                            if (eventsOnItemRoom[_i57].id !== eventsInInterval[_l].id) {
                                var _startOfEvent3 = Date.parse(date.start);
                                var _endOfEvent3 = Date.parse(date.end);
                                var _startOfItem3 = Date.parse(eventsOnItemRoom[_i57].dateStart);
                                var _endOfItem3 = Date.parse(eventsOnItemRoom[_i57].dateEnd);
                                var _start6 = _startOfEvent3;
                                var _end6 = _endOfEvent3 - 60000;
                                var _start7 = _startOfItem3;
                                var _end7 = _endOfItem3;
                                if ((_start6 < _start7 || _start6 > _end7 - 60000) && (_end6 < _start7 || _end6 > _end7) && (_start7 < _start6 || _start7 > _end6)) {} else {
                                    askNow = false;
                                }
                            }
                        }

                        if (_room2.capacity >= document.querySelector('.selected_users').childNodes.length && askNow) {
                            document.querySelector('#rooms').innerHTML = document.querySelector('#rooms').innerHTML + ('<p class="forSending" data-event-id="' + eventsInInterval[_l].id + '" data-room-id="' + rooms[_k2].id + '">\u041F\u0435\u0440\u0435\u043D\u0435\u0441\u0442\u0438 \u0432\u0441\u0442\u0440\u0435\u0447\u0443 \xAB' + eventsInInterval[_l].title + '\xBB \u0432 \u043A\u043E\u043C\u043D\u0430\u0442\u0443 \xAB' + rooms[_k2].title + '\xBB</p>');
                        }
                    }
                }
            }
...
/*-----------------------------------------------------------------*/
var updateGlobalDate = function updateGlobalDate(date) {
    var day = date.getDate();
    var mounth = date.getMonth();
    var mounths = ['января', 'февраля', 'марта', 'апреля', 'мая', 'июня', 'июля', 'августа', 'сентября', 'октября', 'ноября', 'декабря'];
    var mounthName = mounths[mounth].substr(0, 3);
    var year = date.getFullYear();
    var i = new Date();
    var now = new Date(i.getFullYear(), i.getMonth(), i.getDate(), 3, 0, 0);
    var lastText = void 0;
    if (date.getFullYear() == now.getFullYear() && date.getMonth() == now.getMonth() && date.getDate() - now.getDate() == '1') {
        lastText = "завтра";
    } else if (date.getFullYear() == now.getFullYear() && date.getMonth() == now.getMonth() && now.getDate() - date.getDate() == '1') {
        lastText = 'вчера';
    } else if (date.getFullYear() == now.getFullYear() && date.getMonth() == now.getMonth() && now.getDate() == date.getDate()) {
        lastText = 'сегодня';
    } else {
        lastText = year;
    }

    document.querySelector('.date_now .date').innerHTML = day + ' ' + mounthName + '  \xB7 ' + lastText;
...
var getUsersFromDB = async function getUsersFromDB() {
    await _jquery2.default.ajax({
        type: 'GET',
...
var getRoomsFromDB = async function getRoomsFromDB() {
...
var getEventsFromDB = async function getEventsFromDB(date) {
    date = date.toISOString();
    await _jquery2.default.ajax({
        type: 'GET',
        ...
        success: function success(data) {
            ...
            for (var i = 0; i < events.length; i++) {
                var itemDateStart = Date.parse(events[i].dateStart);
                var itemDateEnd = Date.parse(events[i].dateEnd);
                if (itemDateStart >= sortDataStart && itemDateStart <= sortDataEnd && itemDateEnd >= sortDataStart && itemDateEnd <= sortDataEnd) {
...
var updateRoomsList = function updateRoomsList(rooms) {
    ...
    var time_graphs = document.querySelectorAll('.time_of_events>section');
    for (var _i58 = 0; _i58 < time_graphs.length; _i58++) {
        document.querySelector('.time_of_events').removeChild(time_graphs[_i58]);
    }
    var floors_list = [];
    for (var _i59 = 0; _i59 < rooms.length; _i59++) {
        floors_list.push(rooms[_i59].floor);
    }
    function unique(arr) {
        var obj = {};

        for (var _i60 = 0; _i60 < arr.length; _i60++) {
            var str = arr[_i60];
            obj[str] = true;
        }
    ...
    for (var _i61 = 0; _i61 < floors_list.length; _i61++) {
        var roomsOfFloor = [];
        for (var j = 0; j < rooms.length; j++) {
            if (rooms[j].floor == floors_list[_i61]) {
        ...
        li2.innerHTML = floors_list[_i61] + ' \u044D\u0442\u0430\u0436';
        ul.classList.add("floor");
        ul.appendChild(li2);
        var section = document.createElement('section');
        section.classList.add('times_floor_' + floors_list[_i61]);
        for (var k = 0; k < roomsOfFloor.length; k++) {

            var events_time = document.createElement('div');
            ...
            var room_capacity = document.createElement('div');
...
var addToEvent = function addToEvent(article, event) {
    var id = +article.dataset.userId;
    event.users.push({ id: id });
};

var removeFromEvent = function removeFromEvent(article, event) {
...
var removeUsers = function removeUsers() {
    var list1 = document.querySelector('.selected_users');
    while (list1.firstChild) {
        list1.removeChild(list1.firstChild);
    };
    var list2 = document.querySelector('.users_list>section');
    while (list2.firstChild) {
        list2.removeChild(list2.firstChild);
    }
};

var createUsers = function createUsers(userList, event) {
    for (var i = 0; i < userList.length; i++) {
        if (event === false) {
            var article = document.createElement('article');
            article.dataset.userId = userList[i].id;
            article.dataset.userFloor = userList[i].homeFloor;
            article.innerHTML = '<div class="user_img"></div>\n             <div class="user_name">' + userList[i].login + ' \xB7 <a class="user_floor">' + userList[i].homeFloor + ' \u044D\u0442\u0430\u0436</a></div>';
            ...
            if (hasInEvent) {
                ...
                _article.dataset.userId = userList[i].id;
                _article.dataset.userFloor = userList[i].homeFloor;
                _article.innerHTML = '<div class="selected_user_img"></div>\n                 <div class="selected_user_name">' + userList[i].login + '</div>\n                 <div class="delete_user"></div>';
                document.querySelector('.selected_users').appendChild(_article);
                ...
                var _article2 = document.createElement('article');
                _article2.dataset.userId = userList[i].id;
                _article2.dataset.userFloor = userList[i].homeFloor;
                _article2.innerHTML = '<div class="user_img"></div>\n             <div class="user_name">' + userList[i].login + ' \xB7 <a class="user_floor">' + userList[i].homeFloor + ' \u044D\u0442\u0430\u0436</a></div>';
                document.querySelector('.users_list>section').appendChild(_article2);
                document.querySelector('article[data-user-id="' + userList[i].id + '"]>.user_img').style.backgroundImage = 'url(' + userList[i].avatarUrl + ')';
            }
        }
    }
